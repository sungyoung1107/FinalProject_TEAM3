...
<main class="emPage__public">
  ...
  <!-- Start npBalabce_section -->
  <section class="npBalabce_section with_image padding-20 pb-0">
    <h5> 지도 공간 </h5>
<%--    <div class="content_balance">--%>
<%--      <div class="txt">--%>
<%--        <span class="text_b color-snow">My Balance</span>--%>
<%--        <h3 class="color-white">95.00 <span>USD</span> </h3>--%>
<%--        <p class="date color-text">Exp on Jan 15, 2021</p>--%>
<%--      </div>--%>
<%--      <div class="action">--%>
<%--        <a href="#" class="btn">--%>
<%--          + Add Balance--%>
  ...
  <section class="np__bkOperationsService padding-25">
    <div class="em__actions">
          ...
          <svg id="Iconly_Bulk_Folder" data-name="Iconly/Bulk/Folder"
            ...
            <g id="Folder" transform="translate(2 2)">
              ...
              <path id="Folder-2" data-name="Folder"
                    ...
                    transform="translate(0 3.099)" fill="#ff4040" />
            </g>
          </svg>
        </div>
        <span>Package</span>
          ...
          <svg id="Iconly_Bulk_Game" data-name="Iconly/Bulk/Game"
            ...
            <g id="Game" transform="translate(2 2)">
              <path id="Game_2" data-name="Game 2"
                    ...
                    transform="translate(5.623 0)" fill="#41bd83" opacity="0.4" />
              <path id="Game-2" data-name="Game"
                    ...
                    transform="translate(0 4.056)" fill="#41bd83" />
            </g>
          </svg>
        </div>
        <span>Add Ons</span>
          ...
          <svg id="Iconly_Bulk_Paper_Download" data-name="Iconly/Bulk/Paper Download"
            ...
            <g id="Paper_Download" data-name="Paper Download" transform="translate(3.5 2)">
              ...
              <path id="Fill_6" data-name="Fill 6"
                    ...
                    transform="translate(4.61 6.736)" fill="#fa9905" />
            </g>
          </svg>
        </div>
        <span>Request</span>
      ...
      <button type="button" class="btn" data-toggle="modal" data-target="#mdllOthers">
        <div class="icon border border-snow stroke-secondary">
...
<%--      <h3 class="size-18 weight-500 color-secondary m-0">Active Package (3)</h3>--%>
...
<%--        </div>--%>
<%--        <div class="sideRight">--%>
<%--          <p class="q_np">610 MB <span>/ 2 GB</span></p>--%>
<%--          <div class="progress border-snow mb-2 rounded-pill h-5">--%>
<%--            <div class="progress-bar progress-bar-striped bg-orange h-6 rounded-pill"--%>
...
<%--        </div>--%>
<%--        <div class="sideRight">--%>
<%--          <p class="q_np">24 min <span>/ 60 min</span></p>--%>
<%--          <div class="progress border-snow mb-2 rounded-pill h-5">--%>
<%--            <div class="progress-bar progress-bar-striped bg-primary h-6 rounded-pill w-50"--%>
...
<%--      <div class="item_trans" data-toggle="modal" data-target="#mdllDetailsTrans">--%>
<%--        <div class="media sideLeft">--%>
<%--          <div class="icon_img border border-snow fill-pink">--%>
<%--            <svg id="Iconly_Bulk_Chat" data-name="Iconly/Bulk/Chat"--%>
<%--                 xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">--%>
<%--              <g id="Chat" transform="translate(1.667 1.667)">--%>
<%--                <path id="Fill_1" data-name="Fill 1"--%>
<%--                      d="M8.35,0A8.333,8.333,0,0,0,0,8.333a8.8,8.8,0,0,0,1.125,4.158.871.871,0,0,1,.058.75L.625,15.108a.52.52,0,0,0,.683.65l1.683-.5a1.42,1.42,0,0,1,1.243.3A8.322,8.322,0,1,0,8.35,0"--%>
<%--                      fill="#b841bd" opacity="0.4" />--%>
<%--                <path id="Combined_Shape" data-name="Combined Shape"--%>
<%--                      d="M7.684,1.067A1.067,1.067,0,1,1,8.75,2.134,1.063,1.063,0,0,1,7.684,1.067ZM3.842,1.058A1.067,1.067,0,1,1,4.909,2.134,1.076,1.076,0,0,1,3.842,1.058ZM0,1.067a1.067,1.067,0,0,1,2.133,0A1.075,1.075,0,0,1,1.067,2.134,1.074,1.074,0,0,1,0,1.067Z"--%>
<%--                      transform="translate(3.408 7.275)" fill="#b841bd" />--%>
<%--              </g>--%>
<%--            </svg>--%>
<%--          </div>--%>
<%--          <div class="media-body my-auto">--%>
<%--            <h4>SMS Neo.</h4>--%>
<%--            <p>Exp on Oct 12, 2021</p>--%>
<%--          </div>--%>
<%--        </div>--%>
<%--        <div class="sideRight">--%>
<%--          <p class="q_np">24 sms <span>/ 30 sms</span></p>--%>
<%--          <div class="progress border-snow mb-2 rounded-pill h-5">--%>
<%--            <div class="progress-bar progress-bar-striped bg-pink h-6 rounded-pill"--%>
...
<%--  </section>--%>
  ...
  <section class="banner_swiper npSwiper__ads bg-white np_Package_ac padding-t-10 mt-0 padding-b-40">
    <div class="title d-flex justify-content-between align-items-center padding-l-20 padding-r-20">
      <div>
        <h3 class="size-18 weight-500 color-secondary m-0">Offers</h3>
        <p class="size-13 color-text m-0 pt-1">Enjoy! the best offers</p>
      </div>
      <a href="#" class="d-block color-blue size-14 m-0 hover:color-blue">See all</a>
    </div>
    <!-- Swiper -->
